...
function NumResult() {
  return(
    <p className="search-results"> Found <strong>4</strong> results</p>
  )
}
...
function Main() {
  ...
  const [selectedAnime, setSelectedAnime] = useState(animes[0]); // pindahkan ke bawah
...
function ListBox({onSelectedAnime, animes}) {
